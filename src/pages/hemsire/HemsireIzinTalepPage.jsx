// src/pages/hemsire/HemsireIzinTalepPage.jsx
...
const HemsireIzinTalepPage = () => {
  ...
  const fetchMevcutTalepler = useCallback(async () => {
    ...
    setError('');
    try {
      // Bu servis, giriş yapmış personelin kendi izin taleplerini getirir.
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Backend'deki /api/izintalepleri (POST) endpoint'i çağrılır.
      // JWT'den talepEdenPersonelId backend'de alınır.
      ...
      setFormError(err.response?.data?.message || err.message || 'İzin talebi oluşturulurken bir hata oluştu.');
    }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-8">İzin Taleplerim (Hemşire)</h1>
...
export default HemsireIzinTalepPage;